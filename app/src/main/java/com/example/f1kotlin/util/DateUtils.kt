package com.example.f1kotlin.util
...
/**
 * Composable-обёртка для открытия URL через системный браузер.
 * [LocalContext] даёт доступ к Android Context внутри Compose-дерева.
 */
@Composable
fun OpenUrlEffect(url: String) {
