package com.example.f1kotlin.ui.views
 ...
 * Встраивается через [androidx.compose.ui.viewinterop.AndroidView] в [com.example.f1kotlin.ui.components.TableHeaderRow].
 */
