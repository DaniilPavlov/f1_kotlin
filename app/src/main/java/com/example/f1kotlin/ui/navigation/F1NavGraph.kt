package com.example.f1kotlin.ui.navigation
...
import com.example.f1kotlin.ui.components.F1AppBar
import com.example.f1kotlin.ui.screens.circuits.CircuitDetailScreen
import com.example.f1kotlin.ui.screens.circuits.CircuitsScreen
import com.example.f1kotlin.ui.screens.halloffame.HallOfFameScreen
import com.example.f1kotlin.ui.screens.home.HomeScreen
import com.example.f1kotlin.ui.screens.results.RaceInfoScreen
import com.example.f1kotlin.ui.screens.results.RaceSearchScreen
import com.example.f1kotlin.ui.screens.results.ResultsScreen
import com.example.f1kotlin.ui.screens.schedule.ScheduleScreen
...
sealed class BottomTab(val route: String, val label: String, val iconRes: Int) {
    data object Home : BottomTab("home", "Главная", com.example.f1kotlin.R.drawable.nav_home)
    data object Results : BottomTab("results", "Результаты", com.example.f1kotlin.R.drawable.nav_racing_car)
    data object Schedule : BottomTab("schedule", "Календарь", com.example.f1kotlin.R.drawable.nav_lights)
    data object HallOfFame : BottomTab("hall_of_fame", "Зал славы", com.example.f1kotlin.R.drawable.nav_trophy)
    data object Circuits : BottomTab("circuits", "Трассы", com.example.f1kotlin.R.drawable.nav_circuit)
}
